...
(
    ...
    localparam PAD6 = log2ceil(64'h1002050 - 64'h1002040); 
    localparam PAD7 = log2ceil(64'h1002058 - 64'h1002050); 
    localparam PAD8 = log2ceil(64'h100205c - 64'h1002058); 
    // -------------------------------------------------------
    ...
    // ( 0x1002040 .. 0x1002050 )
    if ( {address[RG:PAD6],{PAD6{1'b0}}} == 25'h1002040   ) begin
            src_channel = 9'b000000100;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 4;
    end

    // ( 0x1002050 .. 0x1002058 )
    if ( {address[RG:PAD7],{PAD7{1'b0}}} == 25'h1002050   ) begin
            src_channel = 9'b000000001;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 2;
    end

    // ( 0x1002058 .. 0x100205c )
    if ( {address[RG:PAD8],{PAD8{1'b0}}} == 25'h1002058   ) begin
